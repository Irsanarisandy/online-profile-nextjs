...
export const GitHubLogo = ({ bgColor, fill }: IProp) => (
  <svg
    role="img"
    viewBox="0 0 24 24"
...
export const GitLabLogo = ({ bgColor, fill }: IProp) => (
  <svg
    role="img"
    viewBox="0 0 24 24"
...
export const LinkedInLogo = ({ bgColor, fill }: IProp) => (
  <svg
    role="img"
    viewBox="0 0 24 24"
...
export const FeedLogo = ({ bgColor, fill }: IProp) => (
  <svg
    role="img"
    viewBox="0 0 20 20"
